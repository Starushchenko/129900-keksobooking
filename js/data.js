    ...
    for (var i = 0; i < ADS_COLLECTION_SIZE; i++) {
      ...
      adsCollection[i] = {
        ...
        'offer': {
          ...
          'type': lodgeTypes[window.utils.randomArrIndex(lodgeTypes)],
          'rooms': window.utils.randomNumber(1, 5),
          'guests': window.utils.randomNumber(1, 15),
          'checkin': checkTimes[window.utils.randomArrIndex(checkTimes)],
          'checkout': checkTimes[window.utils.randomArrIndex(checkTimes)],
